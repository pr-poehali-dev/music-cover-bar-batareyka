...
const Index = () => {
  ...
  const menuItems = {
    drinks: [
      ...
      { name: "Лагер KRONE 0.5л", price: "450₽", description: "Классическое бельгийское пиво" },
    ],
    food: [
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section
        ...
        style={{
          backgroundImage: `linear-gradient(rgba(26, 31, 44, 0.6), rgba(26, 31, 44, 0.6)), url('https://cdn.poehali.dev/files/1000010552.jpg')`,
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="animate-scale-in">
              <img
                src="https://cdn.poehali.dev/projects/53b7f04f-914f-4775-8907-af61c06e571e/files/13bfdfe9-f1e3-4b1c-9f93-09a1f5d82040.jpg"
                alt="Бар временно не работает"
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+79017075859" className="text-primary text-lg hover:underline block mb-1">
                      +7 (901) 707-58-59
                    </a>
                    <a href="tel:+79262457585" className="text-primary text-lg hover:underline block">
                      +7 (926) 245-75-85
                    </a>
                  </div>
                </div>
